...
describe "User pages" do
  ...
  describe "index" do
    ...
    describe "pagination" do
      ...
      end # end of should list each user
  ...
  describe "signup" do
    ...
    describe "with invalid information" do
      ...
      describe "after submission" do
        ...
        it { should have_selector('li', text: "Name is too short") }
    ...
    end # end of describe with invalid information
    ...
    end # end of describe with valid information
  end # end of describe sign up
  ...
  describe "edit" do
    ...
    describe "with valid information" do
      ...
      let(:new_email) { "luser@example.com" }
